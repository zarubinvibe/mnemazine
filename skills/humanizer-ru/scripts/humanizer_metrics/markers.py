...
Вордлисты вынесены один-в-один из SKILL.md (разделы «Жесткие запреты» и
...
тут не ловится принципиально, для нее нужен сам скилл.
...
SCANNER: dict[str, list[str]] = {
    ...
    "Чатбот": [
        "конечно!", "отличный вопрос", "давайте разберемся", "давайте разберемся",
    ...
    "Вводные-открытия": [
        ...
        "все чаще", "все чаще", "по мнению экспертов", "специалисты отмечают",
    ],
    "Модальные хеджи": [
    ...
    "Контекстуализаторы": [
        "в условиях", "в свете", "на фоне", "с учетом", "с учетом",
    ...
    "Авторитетные трюизмы": [
        ...
        "первый шаг — это", "первый шаг - это", "по своей сути", "в конечном счете",
        "в конечном счете",
    ],
